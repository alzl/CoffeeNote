...
<!-- Kakao Maps API 스크립트 -->
<script src="https://dapi.kakao.com/v2/maps/sdk.js?appkey=98bcbc7e9ebc254c6d4372a911d9d03b&libraries=services"></script>
</head>
<body>
...
<!-- 검색창과 버튼을 포함하는 폼 -->
<div id="searchForm">
    <form action="/test/searchmap" method="post" accept-charset="UTF-8">
