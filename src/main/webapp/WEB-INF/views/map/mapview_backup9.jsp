<!-- ~0929 리뷰추가시에 카페 상세정보 안뜨던 오류 해결, 카페 info모달 뜨기 성공 -->
...
<div id="cafeInfoModal">
    ...
    <h1 id="cafeInfoTitle" style="color: #914333;"></h1>

    <p id="cafeInfoContent" style="font-size: 20px;"></p>
        ...
        success: function(mediaItems) {
            ...
            if (mediaItems.length > 0) {
                mediaItems.forEach(function(item) {
                    if (item.type === 'review') {
                        reviewListHtml += generateReviewHtml(item); // 리뷰 HTML 생성
                    }
                });
            } else {
            ...
            document.getElementById('reviewList').innerHTML = reviewListHtml; // 리뷰 목록 갱신
        },
        error: function(err) {
